...
class I18n
{
    ...
    private static array $contentTranslations = [
        'es' => [
            ...
            'Actions' => 'Acciones',
            'Edit Request' => 'Modificar',
            'Edit Leave Request' => 'Modificar permiso',
            'Update Request' => 'Guardar cambios',
            'Update Request and Resubmit' => 'Guardar y reenviar solicitud',
            'Approved requests will be sent for review again after editing.' => 'Los permisos aprobados se reenviarán para revisión después de modificarlos.',
